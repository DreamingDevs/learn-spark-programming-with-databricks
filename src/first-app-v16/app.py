...
def main(source_file, output_files_dir, config_file_path):
    # Logging
    logger = Logger("INFO").getLogger()

    logger.info(f"source_file: {source_file}, output_files_dir: {output_files_dir}, config_file_path: {config_file_path}")
