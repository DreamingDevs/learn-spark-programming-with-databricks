...
if __name__ == "__main__":
    ...
    # Calculate various aggregations per movie
    movie_ratings_df = movie_ratings_df.groupBy("movie_id", "title", "genre", "release_year", "duration") \
                                     .agg(
                                         ...
                                         variance("rating").alias("variance_rating"),
                                         approx_count_distinct("rating").alias("acd_rating"),
                                         first("rating").alias("first_rating"),
                                         last("rating").alias("last_rating")
                                     )
